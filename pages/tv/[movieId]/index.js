...
export async function getServerSideProps(context) {
  ...
  // console.log(movieId)
  let res = await fetch(
    `https://api.themoviedb.org/3/tv/${movieId}?api_key=33cc0aef002c1a8fa4097c4a7ffe04f7&language=en-US`
  );
  const data = await res.json();
  res = await fetch(
    `https://api.themoviedb.org/3/tv/${movieId}/credits?api_key=33cc0aef002c1a8fa4097c4a7ffe04f7&language=en-US`
  );
